  ...
  return (
    <div className="section" ref={props.secref}>
      ...
      <div className="section-text">
        <p>
            Bryllupet er 23. juli 2023 i Levanger. Vi gifter oss i Alstahaug kirke klokka (noe), før veien går til Øyna kulturlandskapshotell. Der blir det middag og fest.  
        </p>
        </div>
    </div>
  );
