  ...
  return (
    <div className="section" ref={props.secref}>
      ...
      <div className="section-text">
        <p>
            Bryllupet er søndag 23. juli 2023 i Levanger. Vi gifter oss i Alstadhaug kirke klokka 13:00, før veien går til Øyna kulturlandskapshotell. Der blir det servering og feiring.  
        </p>
        </div>
    </div>
  );
